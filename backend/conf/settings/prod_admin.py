...
SECRET_KEY = 'SECRET_KEY_GERNERATOR' # 배포시 변경해서 seret_key 넣어줌

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False
ALLOWED_HOSTS = ['api.nrise.com'] # 실서버 호스트 (임의)

ROOT_URLCONF = 'urls.admin_url'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'nrisedb',
        'OPTIONS': {
            'read_default_file': "PROD_MYSQL_CONFIG",
            'charset': 'utf8mb4',
